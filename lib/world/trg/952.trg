...
if %actor.str% > 24
wait 5
osend %actor% _Вы вцепились в кедр своей мощной хваткой и чуть не вырвали его с корнем!
oechoaround %actor% %actor.iname% вцепил%actor.u% в кедр и начал%actor.g% его лихо раскачивать.
oecho _Ветви кедра подозрительно зашевелились.
wait 10
...
osend %actor% _Вы вцепились в кедр обоими руками, но не смогли его покачнуть.
...
думать
wait 2s
mecho _- Наверно, ты хочешь попасть к новому храму этих наемников.
...
mecho _- На другое, ваши геройские головы и не способны небось.
wait 10
mecho _- Ну да ладно.
...
ржа
wait 15
mecho _- Есть у меня пара задания для тебя.
...
wait 15
mecho _- Ладно.
mecho _- Во первых, принеси мне кедровую шишку.
mecho _- Жуть как хочу орехов кедровых откушать.
mecho _- Но, с тех пор, как там змей поселился, даже подходить страшно.
дрожать
wait 15
...
~
set char %random.pc%
msend %char% _Сильнейшим ударом крыла большой орел завалил вас на землю!
  %char.position(6)%
  %char.wait(6)%
mechoaround %char% _Сильнейшим ударом крыла большой орел завалил %actor.rname% на землю!
~
#95218
...
mecho _- Говори что тебе здесь надо или уходи.
...
хох
mecho _Хранитель храма:
mecho _- И ты подумал%actor.g% что этот жалкий клочок бересты поможет тебе попасть внутрь?
mecho _Хранитель дико рассмеялся и разорвал разрешение на мелкие клочки.
wait 15
mecho _- Вали от сюда малявка, пока мне не пришлось порубить тебя на куски!
calcuid fromid 95221 mob
...
wait 10
mecho _Хранитель храма:
mecho _- Не знаю как ты узнал%actor.g% о том, что я давно желал заполучить этот меч.
...
mecho _- Да только тот не как не хочет его прода...
...
break
case 2
mecho _- Нет у меня ни какого меча и на когда не было!
...
wait 1s
mecho _Высокий, рыжеволосый человек с явной не охотой последовал за ним. 
wait 2s
...
mecho _Седой старейшина:
mecho _- Мы посовещались, и решили немного подучить тебя, с учетом твой профессии.
...
case 3
  ...
  elseif %actor.skill(бог молот)% < 140
...
case 4
  ...
  elseif %actor.skill(скрытый удар)% < 140
...
case 5
  ...
  elseif %actor.skill(осторожный стиль)% < 140
...
case 9
  ...
  elseif %actor.skill(точный стиль)% < 140
...
case 11
  ...
  elseif %actor.skill(оглушить)% < 140
...
case 12
  ...
  elseif %actor.skill(метнуть)% < 140
...
case 13
  ...
  elseif %actor.skill(сглазить)% < 140
...
wechoaround %actor% _Ловко изогнувшить %actor.iname% полез%actor.q% через кусты.
if %random.3% == 2
