...
думать
wait 1s
г Вот если бы мне вернуть мою руну, я бы смогли бы вернуться домой с поднятой головой!
...
0 f 100
~
if %world.curobjs(1286)% < 1 && if %world.curobjs(1287)% < 1 && %random.100% < 3
mload obj 1286
end
...
г Убирайся от сюда, пока я не позвал своих подопечных.
дум %actor.iname%
wait 1s          
г Хотя. Постой. 
...
г Ну так я и думал.
г Тав вот, что тебе необходимо сделать.
wait 1s
...
wait 1s
г Я хочу, что бы та покарал%actor.g% его.
