...
г А теперь ты открыл%actor.g% дверь и просто обязан%actor.g% помоч мне с ними!
эмо сильно задрожал
wait 1s
...
wait 1s
пока   
mpurge Голова главы налетчиков
end
end
