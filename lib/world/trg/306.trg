...
say Ни в чем я не виноваи.. это все
...
wait 10s
emot воровато оглянувшись, выкинул в окно что-то похожее на камушек, с привязаной к нему запиской
...
say Как ты посме%actor.q% притронуться к святыне!
...
say Как посме%actor.q% ты, %actor.name%, кровь проливать в священной обители?!
say Стража!
msend %actor% Тут же понабежавшие монахи утащили вас в темницу.
mechoaround %actor% Откуда ни возмись сбежалась толпа монахов и утащила %actor.rname%!
...
wait 1s
say За труд свой заслужи%actor.q% ты награду.
mpurge %object%
exec 30618 %self.id% 
halt
end
...
0 z 0
~
*тут должна быть награда за квест 
switch %questor306.class% 
*лекарь
case 0
г Вот твоя награда
mload obj 30631
