...
mecho _- Так вот на этой дороге нежить лютюет.
...
if %questor471.id% != %actor.id% 
  ...
  wechoaround %actor%   %actor.name% полконил%actor.u% могиле, почтя память павшего.
  wecho ...но более ничего интересного не случилос.
  halt
end
wecho На могилкой неожиданно возник дух изрубленного воина.
