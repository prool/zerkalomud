...
say спасу от них нет - полные отморозки...
...
if !(%arg.contains(девочк)%) 
 ...
 mechoaround %actor% %actor.name% освободи%actor.q% девочку
 wait 3s
...
case 1
  ...
  say Я ее покормил и отправил в избушку отдыхать. 
  say А тебя отблагодарю за дело доброе.
  mecho _Охотник вынул что-то из котомки.
  mload obj 27709
  дать все %actor.name%
  break
case 2
