...
mecho Одна из брызг долетала до %fchar.rname% и обожгла.
mdamage %fchar% 5
break
case 2
...
break
case 2
      wecho Из грохочущих жернов вылетел камешек и попал  %fchar.dname% в живот.
      wdamage %fchar.name% 15
break
case 3
      wecho Из грохочущих жернов вылетел камешек и попал  %fchar.dname% в глаз.
      wdamage %fchar.name% 35
break
case 4
      wecho Жернова развернулись и БОЛЬНО ударили %fchar.rname%.
