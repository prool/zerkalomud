...
wait  6s
msend %actor% Говорят, в тех местах творились злые вещи...
wait  5s
msend %actor% И там, мол, некогда учились одни из самых могущественных магов...
wait  4s
msend %actor% Хотя... может и отправлю я тебя туда. Но взамен ты должен будешь мне принести оттуда пергамент..
wait  5s
