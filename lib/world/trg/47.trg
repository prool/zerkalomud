...
wait 1s
say Сам понимаешь - до деревни тут неблизко, волков в округе хватает, но доселе я и сам с ними справлялся.
...
say Чем смогу - отблагодарю, но на сокровища великие не расчитывай.
смея
say Небогат я, нынче.
if %actor.quested(4700)% == 0
emot подмигнул Вам и что-то прошептал
...
mechoaround %actor% Старый воин дал %actor.dname% несколько наставлений по боевому искуству.
msend %actor% Старый воин дал вам несколько наставлений по боевому искуству.
