...
switch %myvar%
  ...
  break
  case 5
    say - Cтарый рыбак то наш - золотые руки, может из плавника сделать ожерелье, что человеку никакая вода не страшна...
    wait 1
    mecho Корчмарь замолкнул, подмигнул и похлопал по карману.
    set myvar 6
    global myvar
...
~
  ...
  wait 1s
  msend %actor.name% .- Потирая зад, вы стоите у купеческого дома.
...
msend %actor% - Я могу перевести тебя через реку к Переяславлю за 100 кун.
~
#33028
перевоз~
0 m 1
