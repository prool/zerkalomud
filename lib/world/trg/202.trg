...
oechoaround %actor% Лучик света пробежал по идеально острому лезвию меча и  уста %actor.vname% тронула улыбка.
end
...
say И пусть войско егоное устрашится и отсупит от Китежа.
wait 9
взд
...
say А Вы, оставайтесь на пир, сегодня прзадник у ребят
...
0 n0 100
*~
if (%world.curobjs(20204)% < 5) && (%random.1000% <= 25)
   mload obj 20204
end
