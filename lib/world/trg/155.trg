...
wait 3s
say А да чуть не забыла, только не попадись на глаза Скилуру, ты его не сможешь победить!
say Если ты мне найдешь моего мужа, то он даст тебе зеркало, которое поможет тебе 
say победить Скилура. 
say Скажи ему что ты пришел от меня и он поиожет тебе.
...
~
 wait 1
   ...
   взд
   if (%world.curobjs(15517)% < 4) & (%random.10% <= 1)
     ...
     if (%world.curobjs(1734)% < 5) & (%random.1000% == 50)
       mload obj 1734
