...
wait 2s
if %actor.level% <= 24 
mecho _Берегиня погладила Вас по головушке, шепнула что то.....
...
0 d 0
благодарствую спасибо сенкс~
wait 2s
say _Спасибо за слово доброе! Но им жив не будеш...
плакать
wait 2s
...
say_Вот и ладенько.... Вот и хорошо...
mecho _Старик закряхтел довольно.
wait 2 s
mload obj 42203
