                    ...
                    case 9
                      case 10
                        case 11
                          ...
                          say Раз приш%actor.y% ты сюда, выслушай меня...
                          wait 1s
...
wechoaround %actor% _%actor.name% морщась убрал половик 
wait 1s
...
wechoaround %actor% _Постепенно %actor.iname% расковырял проход...
...
if  (%speech% == нет) 
  ...
  wait 1s
  say Пойду к брату, да по пути открою Вам ворота
  say Прощайте!
