...
дум
wait 1s
say Слушай, раз ты пришел к нам в село, помоги излечить кузнеца.
...
взд
wait 1s
г Ну так вот, заболел наш кузнец хворью невиданной, ковать ни чего не может.
...
дум
wait 10
г Если принести ей лекарство, которое избавит ее превращения в рысь каждую ночь
...
0 j 100
~
if (%object.iname% == волшебный цветок)
wait 1s
...
0 j 100
~
if %object.name% == кусок железа  
 wait 10
 mpurge %object.name%
 г Эх, помог ты мне излечится, а я уж постораюсь выкую для тебя что нибудь!
 switch %random.5%
   case 1
     mecho _Кузнец взял кусок железа и начал что-то выковывать из него.
