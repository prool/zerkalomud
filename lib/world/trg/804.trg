...
if ((%random.1000% <= 40) && (%world.curobjs(3305)% < 2))
  mload obj 3305
  г &WКстати - у меня еще одна вещичка лежит. Не помню, то ли витязь, то ли лекарь какой оставили. Держи и ее в награду.&n
  дать все .%actor.name%
end
