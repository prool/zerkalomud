...
г Живут там, непонятные даже мне существа, и правит ими неведамо кто.
wait 2s
...
wait 1s
say Потому как оши%actor.u% ты немного.
emot злобно ощерился
say Мор этот, защиты от которого ты явил%actor.u% просить я же и вызвал!
mecho -Ибо мой род всегда с твоим враждовал.. да и сгинул во времена давние в этой вражде...
mecho -А теперь и вам я погибель принесу, не пощажу никого!
mecho -А твои кости сгниют - и никто не узнает, где ты смерть наш%actor.q%!
хохот
mecho -Призрак взмахнул рукой и вас перенесло неведомо куда!
mteleport all 63705 
wait 1
calcuid delete_trig 63701 mob
mload mob 63712
...
wait 1s 
say Здров%actor/g% будь, %actor.name%!
