...
if (%object.iname% == Фальшивые планы кочевников) && (%exist.mob(80321)%)
mjunk all
...
if (%object.iname% == Планы кочевников) || (!%exist.mob(80321)%)
mjunk all
wait 2s
г Вот молодец!
...
if (%give_item% == 1) && (%world.curobjs(80314)% < 10)
mload obj 80314               
дать меч %quest803.name%
halt
end
if (%give_item% == 2) && (%world.curobjs(80315)% < 10)
mload obj 80315 
