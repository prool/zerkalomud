...
mecho Сторож начал с интересом рассматривать буковки на паргаменте.
wait 3s
...
mechoaround %actor.name%  %actor.name% мощным ударом выбил%actor.g% у умирающего кабана клыки.
mload obj 66902
~
#66913
Репоп~
