...
~
if %random.13% == 1
mecho Кабан разрозился радостным похрюкиванием, отыскав что-то в траве.
end
~
#24103
пчеловод~
...
mecho  Седой отшельник закашлился.
wait 1s
...
msend %actor% - Надоел этот окаяный, каждую весну из леса болото делает. 
...
wait 1s
msend %actor% - Есть у меня сосед Леший, надоел уже пескарь окояный.
...
say Уходи и не вовзращайся, без доказательств его смерти!
брос все
halt
end
wiat 5   
...
msend %actor% - Уходи и не вовзращайся, без доказательств его смерти!
бро все
end
~
#24109
