...
~
  wait 3s
  mecho _Русалки предложила уважаемым посетителям что нибудь купить.
~
#33303
...
~
  ...
  say О! Вы прибыли с Земли! Может быть Вы сможете спасти меня и моих сесер?
...
wait 1
mecho _Через несколько мгновений вы услышади короткие предсмертные вскрики 
...
~
  ...
  mecho _Огромная мурена кинулась в аттаку!
  mkill .%actor.name%
~
#33314
у  мурены~
...
0 f 100
~
if %world.curobjs(1278)% < 1 && if %world.curobjs(1279)% < 1 && %random.100% < 3
mload obj 1278
end
...
0 f 100
~
if (%world.curobjs(205)% < 30) && (%random.5% == 1)
   mload obj 205
end
~
#33323
...
mdamage %actor% 15
say Нет.. Ты ничему не научишся... В боевых делах ты бестолочь.
end
wait 1s
пока
...
wait 1s
say Вот так.. может быть теперь ты станеш лучше разбираться в умении "лидерство".
elseif %killer.skill(лидерство)% < 131
say Раньше я ходил с одним очень опытным человеком..
say И он мне показывал все возможные причуды в нашем путешествии
say И я кое чему у него научился, могу и тебя научить!
wait 1s
mskilladd %killer.name% лидерство 10
wait 1s
say Вот так.. может быть теперь ты станеш лучше разбираться в умении "лидерство".
else
...
wait 1s
say Вот так.. может быть теперь ты станеш лучше разбираться в умении "опознание".
elseif %killer.skill(опознание)% < 131
say В моих путешествиях меня поразил один человек..
say Он запросто распознавал мои вещи, даже не глядя на них!
say И я кое чему у него научился, могу и тебя научить!
wait 1s
mskilladd %killer.name% опознание 10
wait 1s
say Вот так.. может быть теперь ты станеш лучше разбираться в умении "опознание".
else
say Кажется мне, что во всех умениях ты достаточно развит%killer.g%.
...
say местных воров убивал противников. Он делал это с помошью удара в спину.
...
wait 1s
say Вот так.. может быть теперь ты станеш лучше разбираться в умении "заколоть".
elseif %killer.skill(заколоть)% < 131
say В одной из кабацких драк меня поразила быстрота и ловкость, с которой один из
say местных воров убивал противников. Он делал это с помошью удара в спину.
say Он мгновенно появлялся у них из-за спины и наносил коварный удар.
say Я долго учился у него, чтоб уметь так сражаться.
...
mecho Старый учитель на мгновение исчез.
mecho Кто-то нанес Вам УЖАСНЫЙ удар в спину!!!
mskilladd %killer.name% заколоть 10
mdamage %killer% 200
mecho Старый учитель появился снова.
wait 1s
say Вот так.. может быть теперь ты станеш лучше разбираться в умении "заколоть".
...
mdamage %killer% 100
wait 1s
say Вот так.. может быть теперь ты станеш лучше разбираться в умении "подножка".
elseif %killer.skill(подножка)% < 131
say Знаешь, бывал я во многих переделках, и знаю много всего.
say Но могу точно сказать тебе следующее.
say В бою очень важно уложить противника на попу.
say Хоть и говорят что "лежачего не бьют", но это только у них, у честных дураков.
...
mecho Старый учитель сделал Вам подножку.
 ...
 %killer.wait(2)%
mecho Тут же он нанес Вам УЖАСНЫЙ удар!!!
mskilladd  %killer.name% подножка 10
mdamage %killer% 100
wait 1s
say Вот так.. может быть теперь ты станеш лучше разбираться в умении "подножка".
else
...
mdamage %killer% 200
say Может быть теперь ты поймещь все преимущества богатырского удара.
elseif %killer.skill(богатырский молот)% < 131
say Богатырская сила в тебе видна могучая.
say Посему попробую научить тебя приему славному - "богатырский молот".
say Главное тут, замахнуться со всей дури, да и врезать промеж глаз ворогу.
say Примерно вот так!
mecho Учитель подошел к Вам и резко замахнулся!
mecho Богатырский удар Учителя пришелся Вам по вкусу...
mskilladd  %killer.name% богатырский.молот 10
mdamage %killer% 200
say Может быть теперь ты поймещь некоторые особенности богатырского удара.
...
mdamage %killer% 200
say Может быть теперь ты поймещь все преимущества умения "кулачный бой".
elseif %killer.skill(кулачный бой)% < 131
say Богатырская сила в тебе видна могучая.
...
mecho Учитель подошел к Вам и резко замахнулся здоровым кулаком!
mecho Удар Учителя оглушил Вас и порадовал весьма...
mskilladd  %killer.name% кулачный 10
mdamage %killer% 200
say Может быть теперь ты поймещь все преимущества умения "кулачный бой".
else
say Кажется мне, что во всех умениях ты достаточно развит%killer.g%.
...
elseif %killer.skill(проникающее оружие)% < 131
...
mskilladd  %killer.name% проникающее 10
elseif !%killer.skill(подножка)%
say Знаешь, бывал я во многих переделках, и знаю много всего.
say Но могу точно сказать тебе следующее.
say В бою очень важно уложить противника на попу.
...
mecho Учитель сильным прямолинейным ударом сбил Вас с ног!!!
 %killer.position(6)%
 %killer.wait(2)%
say Воо... посиди и подумай.. мож научишся чему в этом славном умении "сбить".
mskillturn %killer.name% сбить set
elseif %killer.skill(сбить)% < 131
...
mecho Учитель сильным прямолинейным ударом сбил Вас с ног!!!
 ...
 %killer.wait(2)%
say Воо... посиди и подумай.. мож научишся чему в этом славном умении "сбить".
mskilladd  %killer.name% сбить 10
...
mecho Рассказал о тех случаях. когда спасал друзй от верной гибели...
...
elseif %killer.skill(спасти)% < 131
...
mskilladd  %killer.name% спасти 10
else
say Кажется мне, что во всех умениях ты достаточно развит%killer.g%.
say Нечему мне тебя учить более..
end
...
mecho Вы почувствовали себя несколько сведующим в умении "точный стиль".
mskillturn %killer.name% точный.стиль set
elseif %killer.skill(точный стиль)% < 131
say Нда... витязей я повидал немало на своем веку...
...
mecho Он рассказал Вам о разных видах животных, где у них уязвимые места.
mecho Учитель детально описал Вам строение человека и указал жизненно важные части тела.
mecho Вы почувствовали себя более сведующим в умении "точный стиль".
mskilladd  %killer.name% точный.стиль 10
else
say Кажется мне, что во всех умениях ты достаточно развит%killer.g%.
say Нечему мне тебя учить более..
~
...
mecho Так-же описал ряд приемов для их удачного использования.
mecho Вы познакомились с умением "луки".
mskillturn %killer.name% луки set
elseif %killer.skill(луки)% < 131
say Хм.. да ты охотник опытный.
дум
say Ладно.. Есть у меня пара приемов из умения "луки", которых и ты не знаеш.
...
mskilladd  %killer.name% луки 10
elseif %killer.skill(маскировка)%
say Расскажу я тебе одну историю, а ты на ус мотай...
mecho Учитель рассказал Вам о встрече с одним из величайших охотниклв,
...
if %killer.skill(маскировка)% < 131
say Расскажу я тебе одну историю, а ты на ус мотай...
mecho Учитель рассказал Вам о встрече с одним из величайших охотниклв,
mecho который мог так маскироваться, что дикие животные не замечали его,
mecho и он мог ловить их руками...
mecho Учитель поведал Вам несколько приемов, чтобы научиться так маскироваться.
mecho Возможно, вы стали более опытны в умении "маскировка".
mskilladd  %killer.name% маскировка 10
else
say Кажется мне, что во всех умениях ты достаточно развит%killer.g%.
say Нечему мне тебя учить более..
~
...
say Встречил я однажды кузнеца знатного в Царе-граде живущего...
...
mskilladd  %killer.name% секиры 10
elseif !%killer.skill(длинные лезвия)%
say Встречил я однажды кузнеца знатного в Царе-граде живущего...
say Тот кузнец большой был мастер по  длиннм мечам.
say Обучил он меня нескольким приемам. Смотри же и запоминай.
mecho Учитель достал откуда-то огромный меч.
mecho Учитель принялся очень быстро крутить-вертеть меч, будто он соломинка.
...
elseif %killer.skill(длинные.лезвия)% < 131
say Встречил я однажды кузнеца знатного в Царе-граде живущего...
say Тот кузнец большой был мастер по  длиннм мечам.
say Обучил он меня нескольким приемам. Смотри же и запоминай.
mecho Учитель достал откуда-то огромный меч.
mecho Учитель принялся очень быстро крутить-вертеть меч, будто он соломинка.
mecho В какой-то момент Вам показалось, что Вы стали опытнее в умении "длинные лезвия".
mskilladd  %killer.name% длинные.лезвия 10
else
say Кажется мне, что во всех умениях ты достаточно развит%killer.g%.
say Нечему мне тебя учить более..
~
...
mskilladd  %killer.name% метнуть 10
else
say Кажется мне, что во всех умениях ты достаточно развит%killer.g%.
say Нечему мне тебя учить более..
~
